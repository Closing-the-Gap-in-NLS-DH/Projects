import{S as v,i as $,s as b,k as g,l as _,m as w,h as f,n as x,b as j,D as M,E as h,o as P,R as S,w as F,a as I,y as T,Q as C,c as O,z as V,A as R,g as z,d as A,B as N}from"../chunks/index.05b06d0d.js";import{_ as B}from"../chunks/preload-helper.41c905a7.js";import{e as y,g as G,i as H,j as J,m as K,k as U,l as q,n as Q}from"../chunks/utils.006d87b8.js";function W(l){let e,a;return{c(){e=g("div"),a=g("div"),this.h()},l(s){e=_(s,"DIV",{class:!0});var t=w(e);a=_(t,"DIV",{class:!0}),w(a).forEach(f),t.forEach(f),this.h()},h(){x(a,"class","h-[34rem] rounded-md font-normal"),x(e,"class","mx-auto max-w-6xl px-4")},m(s,t){j(s,e,t),M(e,a),l[1](a)},p:h,i:h,o:h,d(s){s&&f(e),l[1](null)}}}const Z="https://github.com/M-L-D-H/Closing-The-Gap-In-Non-Latin-Script-Data/blob/master/PROJECTS/";function X(l,e,a){let s,t,r;y.subscribe(o=>{r=o});const d={};P(async()=>{const o=await B(()=>import("../chunks/leaflet-src.987390fb.js").then(n=>n.l),[],import.meta.url);t=o.map(s).setView([51.53443,9.93228],5),o.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:'&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'}).addTo(t);const[L,k]=await G();if(r.length!==L){const n=await H(k),i=J(n),c=K(n);y.set(n),U.set(i),q.set(c)}for(const[n,i]of r){const c=Q(i.project.places),p=`${Z}${n.split("/PROJECTS/")[1]}`;for(const m of c){const u=m.place_name.text+m.coordinates.lat.split(".")[0]+m.coordinates.lng.split(".")[0];if(d[u])d[u].projects.push({title:i.project.title,url:p});else{const D={lat:m.coordinates.lat,lng:m.coordinates.lng,projects:[{title:i.project.title,url:p}]};d[u]=D}}}for(const[,n]of Object.entries(d)){const i=n.projects.map(p=>`<a
							href=${p.url}
							target="_blank"
							rel="noreferrer"
